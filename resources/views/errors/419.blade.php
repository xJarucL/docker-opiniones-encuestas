...
<head>
    ...
    <title>Error 419 - tiempo expirado</title>
...
<body class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-xl text-center text-white px-6">
        ...
        <p class="text-lg mb-6 leading-relaxed">
            Parece que el tiempo de respuesta se agotó. No te preocupes, puedes <a href="{{ route('inicio') }}" class="back">volver al inicio.
        </p>
